...
public class HelperUtility {
    ...
    @SneakyThrows
    public static String getSecurityCredentials(String initiatorPassword) throws FileNotFoundException, NoSuchPaddingException, IllegalBlockSizeException, CertificateException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException, NoSuchProviderException {
